...
namespace OTAI.Scenario {
    ...
    public class AvionPassager : AvionCapacite {
        ...
        public override string ToString() => String.Format("{0} (Avion de passagers), Capacité : {1}, Vitesse : {2}, Temps d'embarquement : {3}, débarquement : {4}, entretien : {5}", Nom, capacite, Vitesse, embarquement, debarquement, Entretien);
